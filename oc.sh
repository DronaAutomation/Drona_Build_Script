...
function variables() {
    ...
    ESSENTIAL_VARIABLES() {
        TOOLCHAIN_DIR=DronaKernel/build/oc/toolchain
        KERNEL_DIR=DronaKernel/build/oc/kernel
        KERNEL_OUTPUT_DIR=DronaKernel/build/oc/out
    ...
    OPTIONAL_VARIABLES() {
        ...
        anykernel() {
            essential_variables() {
                AK_DIR=DronaKernel/build/oc/anykernel3
